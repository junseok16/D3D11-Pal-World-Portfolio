...
void Client::CIslandLevel::CreatePlayer()
{
	...
	FDebugCameraDesc tDebugCameraDesc;
	tDebugCameraDesc.m_bUseKeyInput = true;
	tDebugCameraDesc.m_bUseMouseInput = true;
	tDebugCameraDesc.m_eMobilityType = EMobilityType::DYNAMIC;
	tDebugCameraDesc.m_vInitPosition = Vector3(-3601.7f, 90.3f, -2690.3f);
	tDebugCameraDesc.m_wstrGameObjectName = L"DebugCamera";

	m_spDebugCamera = CDebugCamera::Create(make_shared<FDebugCameraDesc>(tDebugCameraDesc));
	CWorld::GetInstance()->GetPersistentLevel()->AddGameObject(m_spDebugCamera);
}
